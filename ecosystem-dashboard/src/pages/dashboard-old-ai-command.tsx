...
import EmailMetricsWidget from '@/components/dashboard/EmailMetricsWidget';
  ...
  return (
    <DashboardLayout>
      <Box bg={bg} minH="100vh">
        <Container maxW="container.2xl" py={{ base: 3, md: 6 }} px={{ base: 2, md: 4 }}>
          <VStack spacing={{ base: 4, md: 8 }} align="stretch">
            ...
            <Grid templateColumns={{ base: "1fr", lg: "2fr 1fr" }} gap={{ base: 4, md: 8 }}>
              ...
              {/* Right Column - System Health & Email */}
              <MotionGridItem
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
