...
import { ChildLearningDashboard } from '@/components/admin/ChildLearningDashboard';
...
function ChildDetailPage() {
  ...
  // Set the right panel to show the "child-profile" tab and pass child ID
  useEffect(() => {
    if (childId) {
  ...
  const fetchChildDetails = async () => {
    ...
    try {
      ...
      const activityRes = await fetch(`/api/admin/children/${childId}/activity?limit=10`);
        ...
        <VStack spacing={6} align="stretch">
          ...
          <HStack justify="space-between" wrap="wrap" gap={4}>
            ...
            <HStack spacing={3}>
              ...
              <Button
                as={NextLink}
                href={`/admin/family/${childId}/controls`}
                leftIcon={<FiSettings />}
                colorScheme="blue"
              >
                Edit Controls
              ...
              <Stat>
                ...
                <StatHelpText>
                  {pendingApprovals > 0 ? (
                    <Button
                      as={NextLink}
                      href={`/admin/family/${childId}/approvals`}
                      size="xs"
                      colorScheme="orange"
                      variant="link"
                    >
          ...
          <Tabs colorScheme="blue">
            <TabList>
              <Tab><HStack><FiStar /><Text>GooseMind</Text></HStack></Tab>
            ...
            <TabPanels>
              {/* GooseMind Learning Tab */}
              <TabPanel px={0}>
                <ChildLearningDashboard
              ...
              <TabPanel px={0}>
                ...
                <Button
                  as={NextLink}
                  href={`/admin/family/${childId}/activity`}
                  mt={4}
                  variant="outline"
                  leftIcon={<FiActivity />}
                >
