/**
 * PCGApprovalQueue Component
 * 
 * Minimalist, modern queue view for pending Personal Context Graph observations.
...
interface PCGApprovalQueueProps {
  onCountChange?: (count: number) => void;
}

export function PCGApprovalQueue({ onCountChange }: PCGApprovalQueueProps) {
...
export default PCGApprovalQueue;
